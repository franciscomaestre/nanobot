...
class WhatsAppChannel(BaseChannel):
    ...
    async def _send_read_receipt(
        ...
        Customizacion Francisco. Non-fatal: any failure is logged and swallowed
    ...
    async def _handle_neonize_message(self, client: Any, event: Any) -> None:
        ...
        # Customizacion Francisco: enviar acuse de lectura (doble check azul) al
        # recibir un mensaje valido y nuevo. No es fatal si falla.
